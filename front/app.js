...
app.use(function (err, req, res, next) {
  ...
  if (req.app.get('env') !== 'development') {
    ...
    err = { status: err.status || 500, message: err.message || 'Ouve um erro no site!', stack: err.stack || 'Sem log de Erro' }
  }
  ...
  if ((err.status === 500 || err.status === undefined) && req.app.get('env') !== 'development') {
